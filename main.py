...
HELP_HTML = """
<h2 style="color: #333;">FileFinder 使用说明书</h2>
<p><b>FileFinder</b> 是一款专为 Windows 7/10/11 设计的高效文件搜索工具。</p>
<hr>
<h3 style="color: #0066cc;">🚀 核心功能</h3>
<ul>
<li><b>多关键字搜索</b>：输入多个关键词（空格分隔），需<b>同时包含</b>所有关键词。</li>
<li><b>文本内容搜索</b>：深入扫描 .txt, .html 等文件内容，自动识别编码。</li>
<li><b>全文件搜索</b>：勾选后可搜索任意类型文件（非文本仅匹配文件名）。</li>
<li><b>智能预览</b>：点击结果即刻预览，关键词<b>高亮</b>显示。</li>
<li><b>安全预览</b>：非文本文件仅显示路径，防止打开乱码。</li>
</ul>
<h3 style="color: #0066cc;">📖 使用指南</h3>
<ol>
<li><b>选择目录</b>：在顶部下拉框选择或浏览文件夹。</li>
<li><b>输入关键词</b>：填写要查找的内容。</li>
<li><b>选择模式</b>：
    <ul>
    <li><b>默认</b>：只搜文本文件内容。</li>
    <li><b>勾选"搜索所有文件"</b>：搜所有文件名 + 文本内容。</li>
    </ul>
</li>
<li><b>点击搜索</b>：开始扫描，可随时停止。</li>
</ol>
<hr>
